				...
				var
					...
					, fs_error = function() {
						...
						if (force) {
							...
							if (!opened) {
								// Apple does not allow window.open, see https://developer.apple.comlibrary/safari/documentation/Tools/Conceptual/SafariExtensionGuide/WorkingwithWindowsandTabs/WorkingwithWindowsandTabs.html
								view.location.href = object_url;
							}
						}
						filesaver.readyState = filesaver.DONE;
